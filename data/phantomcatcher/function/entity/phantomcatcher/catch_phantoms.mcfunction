    ...
    # Если нет фантомов, которых можно поймать, функция прерывается
    execute unless function phantomcatcher:tick/exist_unprotected_phantom run return fail
    ...
    # Поимка фантомов и отображение этого на ловце
    execute store result score @s phantomcatcher.config run function phantomcatcher:entity/phantomcatcher/catch_phantoms/in_area__macro with storage phantomcatcher run_function
